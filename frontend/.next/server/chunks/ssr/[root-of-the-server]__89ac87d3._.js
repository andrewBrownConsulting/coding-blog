...
"[project]/src/app/editor/data:e97905 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$editor$2f$data$3a$e97905__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/editor/data:e97905 [app-ssr] (ecmascript) <text/javascript>");
...
function Home() {
    ...
    async function getAndAwaitIds() {
        const ids = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$editor$2f$data$3a$e97905__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getIds"])();
        const mappedIds = ids.map((val)=>val.id);
        setIds(mappedIds);
    }
    async function awaitBlogEntry(id) {
        const { title, article, imgCaption } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$db$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBlogEntryWithId"])(id);
        setTitle(title);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__89ac87d3._.js.map